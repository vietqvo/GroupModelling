...
% others
\thesisauthor{An Author}
\thesisauthorlastname{Author}
\thesisauthorpreviousdegrees{BCompSc} % Optional
...
\thesisauthoremail{authora\@@csse.monash.edu.au} % Optional. Note that the @ is
...
\thesissupervisor{Dr. Joe Bloggs}
\thesissupervisoremail{bloggsj\@@csse.monash.edu.au} % Optional

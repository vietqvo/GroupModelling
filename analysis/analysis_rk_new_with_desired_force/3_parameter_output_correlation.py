...
def correlation_test_model_output(v, re, rep_s, rep_ra, att_s, att_ra, y, observation_name,rep_s_att_s,rep_ra_att_ra ):
...
def correlation_analysis(filename, observation_name):
    ...
    rep_s_att_s = df.ix[:, 7].values
    rep_ra_att_ra = df.ix[:, 8].values
    rep_s_att_s = center_normalized(rep_s_att_s)
    rep_ra_att_ra = center_normalized(rep_ra_att_ra)
	
    correlation_test_model_output(v, re, rep_s, rep_ra, att_s, att_ra, y, observation_name,rep_s_att_s,rep_ra_att_ra )

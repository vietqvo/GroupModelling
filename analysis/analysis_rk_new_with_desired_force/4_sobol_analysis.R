...
X11<-read.csv(file="C:\\CrowdModelling\\analysis\\analysis_rk_new_with_desired_force\\X1_new.csv",head=TRUE,sep=",")
X22<-read.csv(file="C:\\CrowdModelling\\analysis\\analysis_rk_new_with_desired_force\\X2_new.csv",head=TRUE,sep=",")
cohesion<- read.csv(file = "C:\\CrowdModelling\\analysis\\analysis_rk_new_with_desired_force\\group_cohesion_output.csv",head=TRUE,sep=",")

...
context_log_file = open( "%s.json" % os.path.join(constants.context_dir, "context_new40-10"))
json_str = context_log_file.read()
context=  json.loads(json_str, cls =ContextLog_Decoder)

repulsive_strength = 2.5 #2.5 3.0 
repulsive_range = 0.3
attraction_strength = 0.8 #1.0
attraction_range = 0.7#0.8

...
class Scenario:
    ...
    def run_aggregate(self,
        ...
        analysis_file = open( "%s-%s.csv" % (os.path.join(constants.analysis_dir, "parameter"),str(index_experiment)), "w",newline='')
        ...
        self.population_generator  =  PopulationGenerator(self.parameters, self.parameters['average_num'], desire_velocity_array, force_array, self.parameter_plot, strTime)         
        ...
        if is_bottle_neck==1:
            ...
            for i in range(population_number):
                self.bottleneck_info.append(dict(
                    ...
                    acceleration =  force_model.a_property(i, "acceleration"),

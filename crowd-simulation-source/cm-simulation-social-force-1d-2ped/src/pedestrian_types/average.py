...
class Average(object):
    def __init__(self, total_num, parameters= {}):
        self.parameters = parameters
     
        self._reset_average_distribution()
        
        self.average_desired_velocities = self.parameters['average_velocity_mean']
        self.average_interaction_strengths = self.parameters['average_force_unit']

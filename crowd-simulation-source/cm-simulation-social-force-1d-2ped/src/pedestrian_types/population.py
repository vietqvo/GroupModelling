...
class PopulationGenerator:
    ...
    def __init__(self, parameters, average_num, quantification_plots, strTime):
        self.parameters = parameters
        
        self.average_generated_pedestrians = []
        self.total_population_num = average_num
        
        self.average_dist = average_distribution(self.total_population_num, parameters)
    ...
    def _create_pedestrian_by_distribution(self, designated_cells,log_generation):
        ...
        designated_cells = [(-14.0,0.0),(3.0,0.0)]

...
timestep              = 0.005 # time step to calculate new position and velocity
total_monitoring_duration_uni_direction = 50 # total time for our simulation in unique directional flow

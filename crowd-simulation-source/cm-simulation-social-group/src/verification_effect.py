...
writer.writerow(["v","re","s","ra","cohesion_degree","average_speed","average_direction"])

start = desired_velocity[0]
while start <=desired_velocity[1]:
    monte_carlos_simulation.run_aggregate(start,acceleration_time[0],interaction_strength[0],interaction_range[0],context,parameter_distribution_plot=False, simulation=True, drawing=False,rep=True)
    writer.writerow((start,acceleration_time[0],interaction_strength[0],interaction_range[0],
...
while start <=acceleration_time[1]:
    monte_carlos_simulation.run_aggregate(desired_velocity[0],start,interaction_strength[0],interaction_range[0],context,parameter_distribution_plot=False, simulation=True, drawing=False,rep=True)
    writer.writerow((desired_velocity[0],start,interaction_strength[0],interaction_range[0],
                     monte_carlos_simulation._get_avg_cohesion_degree(),
                     monte_carlos_simulation._get_avg_speed(),
                     monte_carlos_simulation._get_avg_direction()))
    start += step
...
while start <=interaction_strength[1]:
    monte_carlos_simulation.run_aggregate(desired_velocity[0],acceleration_time[0],start,interaction_range[0],context,parameter_distribution_plot=False, simulation=True, drawing=False,rep=True)
    writer.writerow((desired_velocity[0],acceleration_time[0],start,interaction_range[0],
                     monte_carlos_simulation._get_avg_cohesion_degree(),
                     monte_carlos_simulation._get_avg_speed(),
                     monte_carlos_simulation._get_avg_direction()))
    start += step
...
while start <=interaction_strength[1]:
    monte_carlos_simulation.run_aggregate(desired_velocity[0],acceleration_time[0],interaction_strength[0],start,context,parameter_distribution_plot=False, simulation=True, drawing=False,rep=True)
    writer.writerow((desired_velocity[0],acceleration_time[0],interaction_strength[0],start,
                     monte_carlos_simulation._get_avg_cohesion_degree(),
                     monte_carlos_simulation._get_avg_speed(),
                     monte_carlos_simulation._get_avg_direction()))
    start += step 

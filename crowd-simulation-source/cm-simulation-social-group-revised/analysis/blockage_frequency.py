...
def plot_blockage_frequency(ecape_num_different_prototype,
	...
	ax.set_xticklabels( ('$\geqslant 4$', '$\geqslant 5$', '$\geqslant 6$','$\geqslant 7$','$\geqslant 8$','$\geqslant 9$','$\geqslant 10$',
						 '$\geqslant 11$','$\geqslant 12$','$\geqslant 13$','$\geqslant 14$','$\geqslant 15$','$\geqslant 16$','$\geqslant 17$',
						 '$\geqslant 18$','$\geqslant 19$','$\geqslant 20$') )
	...
	fig.savefig('blockage_frequency_uniform.pdf', bbox_inches='tight')	

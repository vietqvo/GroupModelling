...
while i< 200:
	...
	### perform hypothesis testing on each 20 times
	"""if (i+1) % 20 ==0:
		j = i-19
		p_value_array = []
		escape_rate_temp_differential_prototype = []
		escape_rate_temp_average_prototype = []
		escape_rate_temp_average_cutoff_lv3_prototype = []
		escape_rate_temp_average_cutoff_lv1_prototype = []
		escape_rate_temp_uniform_cutoff_lv3_prototype = []
		escape_rate_temp_uniform_cutoff_lv1_prototype = []
		
		while j <=i: 
			escape_rate_temp_differential_prototype.append(escape_rate_differential_prototype[j])
			escape_rate_temp_average_prototype.append(escape_rate_average_prototype[j])
			escape_rate_temp_average_cutoff_lv3_prototype.append(escape_rate_average_cutoff_lv3_prototype[j])
			escape_rate_temp_average_cutoff_lv1_prototype.append(escape_rate_average_cutoff_lv1_prototype[j])
			escape_rate_temp_uniform_cutoff_lv3_prototype.append(escape_rate_uniform_cutoff_lv3_prototype[j])
			escape_rate_temp_uniform_cutoff_lv1_prototype.append(escape_rate_uniform_cutoff_lv1_prototype[j])
			j+=1
			
		### perform hypothesis testing on each 20 times
		z,pval_differential = stats.normaltest(escape_rate_temp_differential_prototype)
		z,pval_average = stats.normaltest(escape_rate_temp_average_prototype)
		z,pval_average_lv3 = stats.normaltest(escape_rate_temp_average_cutoff_lv3_prototype)
		z,pval_average_lv1 = stats.normaltest(escape_rate_temp_average_cutoff_lv1_prototype)
		z,pval_uniform_lv3 = stats.normaltest(escape_rate_temp_uniform_cutoff_lv3_prototype)
		z,pval_uniform_lv1 = stats.normaltest(escape_rate_temp_uniform_cutoff_lv1_prototype)
		
		p_value_array.append(hypothesis_testing(escape_rate_temp_differential_prototype,pval_differential,escape_rate_temp_average_prototype,pval_average))
		p_value_array.append(hypothesis_testing(escape_rate_temp_differential_prototype,pval_differential,escape_rate_temp_average_cutoff_lv3_prototype,pval_average))
		p_value_array.append(hypothesis_testing(escape_rate_temp_differential_prototype,pval_differential,escape_rate_temp_average_cutoff_lv1_prototype,pval_average))
		p_value_array.append(hypothesis_testing(escape_rate_temp_differential_prototype,pval_differential,escape_rate_temp_uniform_cutoff_lv3_prototype,pval_average))
		p_value_array.append(hypothesis_testing(escape_rate_temp_differential_prototype,pval_differential,escape_rate_temp_uniform_cutoff_lv1_prototype,pval_average))
			
		print('Sampling time'  + str(i+1) + 'p_value array ' + ", ".join([str(k) for k in p_value_array]))"""

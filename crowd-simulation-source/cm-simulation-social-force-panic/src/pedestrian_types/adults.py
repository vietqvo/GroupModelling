    ...
    def _generate_adults_distribution(self,num):
        ...
        if self.parameters['adult_velocity_deviation'] > 0.0:
            while len(self.adults_desired_velocities) < num:
                samples = numpy.random.normal(self.parameters['adult_velocity_mean'], self.parameters['adult_velocity_deviation'], num)
        ...
        if self.parameters['adult_relaxation_deviation'] > 0.0:
            while len(self.adults_relaxation_times) < num:  
                samples = numpy.random.normal(self.parameters['adult_relaxation_mean'], self.parameters['adult_relaxation_deviation'], num)
        ...
        if self.parameters['adult_force_deviation'] > 0.0:
            while len(self.adults_interaction_strengths) < num:        
                samples =  numpy.random.normal(self.parameters['adult_force_unit'], self.parameters['adult_force_deviation'], num)
        ...
        if self.parameters['adult_range_deviation'] > 0.0:
            while len(self.adults_interaction_ranges) < num:
                samples = numpy.random.normal(self.parameters['adult_force_range'], self.parameters['adult_range_deviation'], num)

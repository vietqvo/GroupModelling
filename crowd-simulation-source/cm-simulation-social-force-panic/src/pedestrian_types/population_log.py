...
class PopulationLog(object):
    ...
    def __init__(self, 
                 ...
                 average_cutoff_lv3_radii_distribution,
                 average_cutoff_lv3_cells_distribution,                                       
                 average_cutoff_lv3_seed,
                                         
                 average_cutoff_lv1_radii_distribution,
                 average_cutoff_lv1_cells_distribution,                                         
                 average_cutoff_lv1_seed,
                                         
                 uniform_cutoff_lv3_radii_distribution,
                 uniform_cutoff_lv3_cells_distribution,                                         
                 uniform_cutoff_lv3_seed,
                                         
                 uniform_cutoff_lv1_radii_distribution,
                 uniform_cutoff_lv1_cells_distribution,    
                 uniform_cutoff_lv1_seed
                 ):
        ...
        self.average_cutoff_lv3_radii_distribution = average_cutoff_lv3_radii_distribution
        self.average_cutoff_lv3_cells_distribution=  average_cutoff_lv3_cells_distribution                                       
        self.average_cutoff_lv3_seed= average_cutoff_lv3_seed
                                         
        self.average_cutoff_lv1_radii_distribution = average_cutoff_lv1_radii_distribution
        self.average_cutoff_lv1_cells_distribution=  average_cutoff_lv1_cells_distribution                                        
        self.average_cutoff_lv1_seed= average_cutoff_lv1_seed
                                         
        self.uniform_cutoff_lv3_radii_distribution= uniform_cutoff_lv3_radii_distribution
        self.uniform_cutoff_lv3_cells_distribution= uniform_cutoff_lv3_cells_distribution                                        
        self.uniform_cutoff_lv3_seed= uniform_cutoff_lv3_seed
                                         
        self.uniform_cutoff_lv1_radii_distribution= uniform_cutoff_lv1_radii_distribution
        self.uniform_cutoff_lv1_cells_distribution= uniform_cutoff_lv1_cells_distribution  
        self.uniform_cutoff_lv1_seed= uniform_cutoff_lv1_seed
    ...
    def _get_average_cutoff_lv3_radii_distribution(self):
        return self.average_cutoff_lv3_radii_distribution
    
    def _get_average_cutoff_lv3_cells_distribution(self):
        return self.average_cutoff_lv3_cells_distribution
    
    def _get_average_cutoff_lv3_seed(self):
        return self.average_cutoff_lv3_seed
    
    def _get_average_cutoff_lv1_radii_distribution(self):
        return self.average_cutoff_lv1_radii_distribution
        
    def _get_average_cutoff_lv1_cells_distribution(self):
        return self.average_cutoff_lv1_cells_distribution
    
    def _get_average_cutoff_lv1_seed(self):
        return self.average_cutoff_lv1_seed                                     
              
    def _get_uniform_cutoff_lv3_radii_distribution(self):
        return self.uniform_cutoff_lv3_radii_distribution                                    
    
    def _get_uniform_cutoff_lv3_cells_distribution(self):
        return self.uniform_cutoff_lv3_cells_distribution

    def _get_uniform_cutoff_lv3_seed(self):
        return self.uniform_cutoff_lv3_seed                                  
       
    def _get_uniform_cutoff_lv1_radii_distribution(self):
        return self.uniform_cutoff_lv1_radii_distribution
    
    def _get_uniform_cutoff_lv1_cells_distribution(self):
        return self.uniform_cutoff_lv1_cells_distribution          
    
    def _get_uniform_cutoff_lv1_seed(self):
        return self.uniform_cutoff_lv1_seed  
...
class PopulationLog_Decoder(json.JSONDecoder):
    def decode(self,json_string):
        ...
        average_cutoff_lv3_radii_distribution = []
        for radius in default_obj['average_cutoff_lv3_radii_distribution']:
            average_cutoff_lv3_radii_distribution.append(radius)
        
        average_cutoff_lv3_cells_distribution = []
        for cell in default_obj['average_cutoff_lv3_cells_distribution']:
            average_cutoff_lv3_cells_distribution.append((cell[0],cell[1],cell[2]))
                                             
        average_cutoff_lv3_seed = default_obj['average_cutoff_lv3_seed']
                                         
        average_cutoff_lv1_radii_distribution = []
        for radius in default_obj['average_cutoff_lv1_radii_distribution']:
            average_cutoff_lv1_radii_distribution.append(radius)
            
        average_cutoff_lv1_cells_distribution =[]
        for cell in default_obj['average_cutoff_lv1_cells_distribution']:
            average_cutoff_lv1_cells_distribution.append((cell[0],cell[1],cell[2]))
                                            
        average_cutoff_lv1_seed = default_obj['average_cutoff_lv1_seed']
                                         
        uniform_cutoff_lv3_radii_distribution =[]
        for radius in default_obj['uniform_cutoff_lv3_radii_distribution']:
            uniform_cutoff_lv3_radii_distribution.append(radius)
        
        
        uniform_cutoff_lv3_cells_distribution=[]
        for cell in default_obj['uniform_cutoff_lv3_cells_distribution']:
            uniform_cutoff_lv3_cells_distribution.append((cell[0],cell[1],cell[2]))
                                            
        uniform_cutoff_lv3_seed = default_obj['uniform_cutoff_lv3_seed']
                                         
        uniform_cutoff_lv1_radii_distribution = []
        for radius in default_obj['uniform_cutoff_lv1_radii_distribution']:
            uniform_cutoff_lv1_radii_distribution.append(radius)
        
        uniform_cutoff_lv1_cells_distribution =[]
        for cell in default_obj['uniform_cutoff_lv1_cells_distribution']:
            uniform_cutoff_lv1_cells_distribution.append((cell[0],cell[1],cell[2]))
          
        uniform_cutoff_lv1_seed = default_obj['uniform_cutoff_lv1_seed']
